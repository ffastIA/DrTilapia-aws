# destructive-action-explicit-confirmation Specification

## Purpose
TBD - created by archiving change require-explicit-cleanup-confirmation. Update Purpose after archive.
## Requirements
